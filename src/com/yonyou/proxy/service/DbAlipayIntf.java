...
public interface DbAlipayIntf {
	...
	void saveTradePay(Long sfid, String sqbm, String inputs, String tradeNo, String amount, String storeId,
			String alipayJson, int flag, long t1, long t2);

	void saveTradeQuery(String tradeNo, int flag, String response, long t1, long t2);

	void saveTradeRefund(String tradeNo, String refundAmount, String refundReason, String storeId, String result,
			int flag, long t1, long t2);
}
